...
//first actions is to show the countries 
...
const searchForRecipes = (event) =>{
    ...
    if (name.length === 1){
        ...
        //if the click again it will start again andd check what they put in the form
...
for (let i = 0; i < arrayOfFlags.length; i++){
    ...
    let template = `<img  class = 'foodsimgs' src="../image/${imgData}.png">
